...
export const Platinumpack = () => {
  return (
    ...
    <div className='gold-type'>
            ...
            <br></br>
            <div className="polaroid-gold">
                    <img src="https://makemyevent.in/wp-content/uploads/2018/10/Mascot.jpg" width={400} height={250} alt="Norway" ></img>
                    <div className="container">
                    <center><h2>MASCOT</h2></center>

                    </div>
                </div>
                <div className="polaroid-gold">
                    <img src="https://makemyevent.in/wp-content/uploads/2018/10/Game-Stall.jpg" width={400} height={250} alt="Norway" ></img>
                    <div className="container">
                    <center><h2>GAME STALL</h2></center>

                    </div>
                </div>
                <div className="polaroid-gold">
                    <img src="https://makemyevent.in/wp-content/uploads/2018/10/Magicians.jpg" width={400} height={250} alt="Norway" ></img>
                    <div className="container">
                    <center><h2>MAGICIAN SHOW</h2></center>
        ...
        <div className="b-low">
        <center><Link to="/Platinumevent"><button className="button"><span>Book</span></button></Link></center>
        </div>
    <footer>
